...
## Metadata
- generated_at: 2026-05-10T17:48:38.547808+00:00
- provider: live
...
- finimpulse fundamentals: warning - 23/25 Finimpulse lookups parsed
...
- Finimpulse fundamentals lookup (SPRINT.ST): https://developers.finimpulse.com/v1/search/ (finimpulse)
...
Evidence:
- Nasdaq Nordic listing source: https://api.nasdaq.com/api/nordic/screener/shares (nasdaq)
- Finimpulse fundamentals lookup (ORT-B.ST): https://developers.finimpulse.com/v1/search/ (finimpulse)

#11 Modus Therapeutics Holding (MODTX)
SE | Nasdaq First North Growth Market Sweden | first_north
...
Evidence:
- Nasdaq Nordic listing source: https://api.nasdaq.com/api/nordic/screener/shares (nasdaq)
- Finimpulse fundamentals lookup (MODTX.ST): https://developers.finimpulse.com/v1/search/ (finimpulse)

#12 Refine Group (REFINE)
SE | Nasdaq First North Growth Market Sweden | first_north
...
Evidence:
- Nasdaq Nordic listing source: https://api.nasdaq.com/api/nordic/screener/shares (nasdaq)
- Finimpulse fundamentals lookup (REFINE.ST): https://developers.finimpulse.com/v1/search/ (finimpulse)

#13 AAC Clyde Space (AAC)
SE | Nasdaq First North Growth Market Sweden | first_north
...
Evidence:
- Nasdaq Nordic listing source: https://api.nasdaq.com/api/nordic/screener/shares (nasdaq)
- Finimpulse fundamentals lookup (SINCH.ST): https://developers.finimpulse.com/v1/search/ (finimpulse)
...
#21 Aiforia Technologies Oyj (AIFORIA)
...
Evidence:
- Nasdaq Nordic listing source: https://api.nasdaq.com/api/nordic/screener/shares (nasdaq)
- Finimpulse fundamentals lookup (LITI.ST): https://developers.finimpulse.com/v1/search/ (finimpulse)
