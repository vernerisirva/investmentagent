...
- evaluation: {'run_id': 'evaluation-0a96cd59652f11946bcd09c2', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-08-12T05:00:57.400190Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=38; cache misses=893; cutoff ties=0 (0 excluded)
