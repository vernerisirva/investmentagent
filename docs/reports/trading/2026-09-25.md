...
- evaluation: {'run_id': 'evaluation-88670cab799c0d255d6b25a0', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-25T05:06:05.381211Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=723; cache misses=207; cutoff ties=0 (0 excluded)
