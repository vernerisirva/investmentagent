...
- evaluation: {'run_id': 'evaluation-f98706c858a1d322111c1898', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-01T05:01:54.576734Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=207; cache misses=721; cutoff ties=0 (0 excluded)
