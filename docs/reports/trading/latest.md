...
- evaluation: {'run_id': 'evaluation-b8f0d7bbdd5fe674c4d1e076', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-09T05:06:31.410419Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=381; cache misses=546; cutoff ties=0 (0 excluded)
