...
- evaluation: {'run_id': 'evaluation-81cc0dde37c163648f78533c', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-02T05:06:24.640887Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=236; cache misses=692; cutoff ties=0 (0 excluded)
