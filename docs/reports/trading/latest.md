...
- evaluation: {'run_id': 'evaluation-9cab0214d85836a5648290a2', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-22T05:06:41.291800Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=636; cache misses=292; cutoff ties=0 (0 excluded)
