...
## Metadata
- generated_at: 2026-08-31T05:19:24.788279+00:00
- provider: live
...
- evaluation: {'run_id': 'evaluation-9dfb53032a4e044adb86efcc', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-08-31T05:19:24.788279Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=178; cache misses=751; cutoff ties=0 (0 excluded)
