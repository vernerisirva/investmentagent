...
- evaluation: {'run_id': 'evaluation-963cbcc737ead8d7d40fc807', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-03T05:06:33.870287Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=265; cache misses=663; cutoff ties=0 (0 excluded)
