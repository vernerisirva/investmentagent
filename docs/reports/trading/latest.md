...
## Metadata
- generated_at: 2026-09-04T05:06:22.914158+00:00
- provider: live
...
- evaluation: {'run_id': 'evaluation-ff314cd1ba15d53015813a01', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-04T05:06:22.914158Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=294; cache misses=634; cutoff ties=0 (0 excluded)
