...
- evaluation: {'run_id': 'evaluation-12eaffe31b0161ec0ad5dffc', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-07T05:06:48.888094Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=323; cache misses=605; cutoff ties=0 (0 excluded)
