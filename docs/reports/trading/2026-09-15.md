...
- evaluation: {'run_id': 'evaluation-3ed330cbe7900de74f42ad3a', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-15T05:06:31.217465Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=491; cache misses=436; cutoff ties=0 (0 excluded)
