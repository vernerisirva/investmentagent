...
- evaluation: {'run_id': 'evaluation-168eecb567bd90cb623f05b0', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-08-10T05:42:44.152271Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=0; cache misses=932; cutoff ties=0 (0 excluded)
