...
- evaluation: {'run_id': 'evaluation-a29eaa5fe5f4650f34edc96b', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-17T05:06:24.741317Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=549; cache misses=378; cutoff ties=0 (0 excluded)
