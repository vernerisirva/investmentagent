...
- evaluation: {'run_id': 'evaluation-be5e8c438913bdd3b331fd06', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-08-20T05:06:00.624136Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=159; cache misses=771; cutoff ties=0 (0 excluded)
