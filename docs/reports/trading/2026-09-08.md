...
- evaluation: {'run_id': 'evaluation-bef385daff7325b38026ff24', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-08T05:06:28.385876Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=352; cache misses=575; cutoff ties=0 (0 excluded)
