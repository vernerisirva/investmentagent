...
- evaluation: {'run_id': 'evaluation-d67fc4b818adbe23db867380', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-10T05:00:59.327489Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=404; cache misses=523; cutoff ties=0 (0 excluded)
