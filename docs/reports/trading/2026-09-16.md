...
- evaluation: {'run_id': 'evaluation-39d4c70231da1770c5d798fc', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-16T05:06:38.140155Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=520; cache misses=407; cutoff ties=0 (0 excluded)
