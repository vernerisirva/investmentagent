...
- evaluation: {'run_id': 'evaluation-27a245341909b53537e1d934', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-14T05:01:04.014639Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=462; cache misses=465; cutoff ties=0 (0 excluded)
