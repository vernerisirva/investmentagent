...
- evaluation: {'run_id': 'evaluation-856907e8fcc273fbbe71ee4c', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-18T05:01:08.729627Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=578; cache misses=349; cutoff ties=0 (0 excluded)
