...
- evaluation: {'run_id': 'evaluation-0ba362d11c5e199398198f36', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-09-21T05:06:00.562345Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=607; cache misses=321; cutoff ties=0 (0 excluded)
