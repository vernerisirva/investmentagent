...
- evaluation: {'run_id': 'evaluation-da204d57ff58dd38328bd6fc', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-08-24T05:01:13.241467Z'}
...
- fundamentals enrichment: ok - eligible=0; budget=30; selected=0; attempts=0; successful=0; cache coverage=0/0 (fresh=0, stale=0, missing=0); cache hits=217; cache misses=713; cutoff ties=0 (0 excluded)
