...
## Metadata
- generated_at: 2026-06-15T05:21:10.229574+00:00
- provider: live
...
## Source Checks
- nasdaq nordic live data: ok - 940 companies parsed from https://api.nasdaq.com/api/nordic/screener/shares
...
## #10 Salix Group (SALIX)

`SE` | Nasdaq Stockholm | `main_market`

**What the company does:** Salix Group is a Sweden-listed main market Industrials company on Nasdaq Stockholm.
...
### Long-Term Conviction
**Bucket:** Insufficient evidence
**Thesis:** Salix Group lacks enough durable evidence for a strong long-term thesis today; wait for clearer fundamentals, valuation, liquidity, or business evidence.
