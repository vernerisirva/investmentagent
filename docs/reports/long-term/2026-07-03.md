...
## Metadata
- generated_at: 2026-07-03T05:01:37.465081+00:00
- provider: live
...
## #9 IQM Quantum Computers Oyj (IQMX)

`FI` | Nasdaq Helsinki | `main_market`

**What the company does:** IQM Quantum Computers Oyj is a Finland-listed main market Technology company on Nasdaq Helsinki.
...
### Long-Term Conviction
**Bucket:** Insufficient evidence
**Thesis:** IQM Quantum Computers Oyj lacks enough durable evidence for a strong long-term thesis today; wait for clearer fundamentals, valuation, liquidity, or business evidence.
