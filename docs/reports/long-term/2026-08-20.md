...
## Metadata
- generated_at: 2026-08-20T05:07:19.720171+00:00
- provider: live
- fundamentals: finimpulse
- countries: SE, FI
- limit: 10
- enrichment_limit: 30
- enrichment: {'eligible_universe_size': 930, 'enrichment_budget': 30, 'refresh_budget': 30, 'selected_candidates': 30, 'attempts': 30, 'successful_enrichments': 29, 'cutoff_tie_count': 24, 'cutoff_tie_excluded': 12, 'cache_enabled': True, 'cache_hits': 159, 'cache_misses': 771, 'cache_max_age_days': 45, 'eligible_companies': 930, 'cached_companies': 188, 'fresh_companies': 188, 'stale_companies': 0, 'missing_companies': 742, 'oldest_retrieved_at': '2026-08-10T05:42:52.304259Z', 'newest_retrieved_at': '2026-08-20T05:07:19.656817Z', 'country_coverage': {'SE': {'eligible': 736, 'cached': 41, 'fresh': 41, 'stale': 0, 'missing': 695}, 'FI': {'eligible': 194, 'cached': 147, 'fresh': 147, 'stale': 0, 'missing': 47}}}
...
- evaluation: {'run_id': 'evaluation-7529f60f6f4bb562b01d2c24', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-08-20T05:07:19.720171Z'}
...
- fundamentals enrichment: ok - eligible=930; budget=30; selected=30; attempts=30; successful=29; cache coverage=188/930 (fresh=188, stale=0, missing=742); cache hits=159; cache misses=771; cutoff ties=24 (12 excluded)
...
### Long-Term Conviction
**Bucket:** Speculative small-cap monitor
**Thesis:** Componenta Oyj is an interesting small-cap monitor, but the long-term case needs more proof because no profitability signal.

| Component | Score | View |
| --- | --- | --- |
| Business quality | 3/5 | Clear business profile, but margin data is missing. |
| Valuation | 1/5 | No valuation multiple is available. |
| Growth | 4/5 | Healthy revenue growth of 5.8%. |
| Balance sheet | 4/5 | Balance sheet looks conservative on available metrics. |
| Momentum | 1/5 | Intraday move is not enough for a long-term thesis. |
| Risk | 2/5 | Profitability risk needs manual confirmation. |
| Data confidence | 3/5 | Some fundamentals are available; verify in reports. |
...
### Evidence
- [Nasdaq Nordic listing source](https://api.nasdaq.com/api/nordic/screener/shares) (nasdaq)
- [Finimpulse fundamentals lookup (CTH1V.HE)](https://developers.finimpulse.com/v1/search/) (finimpulse)

## #10 Enersense International Oyj (ESENSE)
