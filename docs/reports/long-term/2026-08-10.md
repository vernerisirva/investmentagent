...
## Metadata
- generated_at: 2026-08-10T05:43:54.073633+00:00
- provider: live
- fundamentals: finimpulse
- countries: SE, FI
- limit: 10
- enrichment_limit: 30
- enrichment: {'eligible_universe_size': 932, 'enrichment_budget': 30, 'refresh_budget': 30, 'selected_candidates': 30, 'attempts': 30, 'successful_enrichments': 29, 'cutoff_tie_count': 293, 'cutoff_tie_excluded': 265, 'cache_enabled': True, 'cache_hits': 0, 'cache_misses': 932, 'cache_max_age_days': 45, 'eligible_companies': 932, 'cached_companies': 29, 'fresh_companies': 29, 'stale_companies': 0, 'missing_companies': 903, 'oldest_retrieved_at': '2026-08-10T05:42:52.304259Z', 'newest_retrieved_at': '2026-08-10T05:43:54.039280Z', 'country_coverage': {'SE': {'eligible': 738, 'cached': 23, 'fresh': 23, 'stale': 0, 'missing': 715}, 'FI': {'eligible': 194, 'cached': 6, 'fresh': 6, 'stale': 0, 'missing': 188}}}
...
- evaluation: {'run_id': 'evaluation-4850c4a75f98ad229cae24a3', 'scoring_model_version': 'nordic-ranking-v1', 'decision_at': '2026-08-10T05:43:54.073633Z'}

## Source Checks
- nasdaq nordic live data: ok - universe coverage: total=940, SE=746, FI=194; STO/main_market=413, HEL/main_market=147, STO/first_north=333, HEL/first_north=47; source=https://api.nasdaq.com/api/nordic/screener/shares
- fundamentals enrichment: ok - eligible=932; budget=30; selected=30; attempts=30; successful=29; cache coverage=29/932 (fresh=29, stale=0, missing=903); cache hits=0; cache misses=932; cutoff ties=293 (265 excluded)
...
- free fundamentals: warning - No successful Yahoo-style fundamentals lookups (0/34 Yahoo-style lookups parsed): HTTP Error 401: Unauthorized
- valuation fallback: warning - 0/30 fallback lookups parsed; 0 fallback valuation enrichments; fallback source: No successful Yahoo-style fundamentals lookups (0/34 Yahoo-style lookups parsed): HTTP Error 401: Unauthorized
...
## #9 Absolent Air Care Group (ABSO)
...
### Long-Term Conviction
**Bucket:** Speculative small-cap monitor
**Thesis:** Administer Oyj is an interesting small-cap monitor, but the long-term case needs more proof because no profitability signal.
